...
<Route path='/search'
     ...
     <Body/>
          ...
          />
        <Route path="/results" element={<FlightsGrid 
            flights={ props.flights} 
            criteria={{origin, destination, date: departureDate}}
          ></FlightsGrid> } />
           <Route path="/registration" element={<Registration />} />  
          <Route path="/booking" element={<MyComponent flights={ props.flights} ></MyComponent>
            
          } />
           <Route path="/contacts" element={<Contacts flights={ props.flights} ></Contacts>
